     					...
     					<td align="right" style="padding-right:10px;font-size:10pt;font:bold;">
     						<c:choose>
     							<c:when test="${empty sessionScope.user}">
     								<a target="_content" href="user/reg.html">注册</a>
     	...
     	<tr id="content">
     		<td style="width:120px;vertical-align:top;padding:10px;">
     			<div class="menu" onmousemove="chg(this);" onmouseout="_chg(this);">
     					<a target="_content" href="${pageContext.request.contextPath }/index?action=ShowBook" class="type">
     						全部
     					</a>
     			</div>
     			<c:forEach items="${Type}" var="type">
     				<div class="menu" onmousemove="chg(this);" onmouseout="_chg(this);">
     					<a target="_content" href="${pageContext.request.contextPath }/index?action=ShowBook&typeid=${type.id}" class="type">
     						${type.NAME }
     					</a>
     				</div>
				</c:forEach>
     		...
     		<td>
     			...
     			<iframe id="_content" scrolling="no" name="_content" src="${pageContext.request.contextPath }/index?action=ShowBook" frameborder="0" width="800px" height="600px">
     			</iframe>
     		</td>
     	</tr>
     </table>
